/*! @mainpage Guia1_Ej4
 *
 * @section genDesc Proyecto 1 - Ejercicio 4
 *
 * El programa permite la visualización de una serie de dígitos en una pantalla LCD
 * Los datos recibidos se convierten a BCD, y mediante cambios de estado en cada GPIO se muestra
 * el valor por el display de 7 segmentos
 *
 ...
 * |   Fecha    | Descripcion                                    |
 * |:----------:|:-----------------------------------------------|
 * | 20/03/2024 | Creacion del documento                         |
 *
